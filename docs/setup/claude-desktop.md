...
```json
"agent-zot": {
  "command": "/Users/claudiusv.schroder/toolboxes/agent-zot/.venv/bin/agent-zot",
  "args": ["serve"],
  "env": {
    "ZOTERO_LOCAL": "true"
  }
...
- **Virtual Environment:** `~/toolboxes/agent-zot/.venv/`
- **Python Version:** 3.12
- **Executable:** `~/toolboxes/agent-zot/.venv/bin/agent-zot`
...
- Check executable path exists: `ls -la ~/toolboxes/agent-zot/.venv/bin/agent-zot`
